...
// Constructores
InformacionCurso::InformacionCurso(string name, string desc, difficulty difi,bool habilitado, set<string> previos, string idi, string prof, int cLec, int cEj, float prom){
    this->Nombre = name;
...
InformacionCurso::InformacionCurso(string name, string desc, difficulty difi,bool habilitado, string idi, int cLec, int cEj){
    this->Nombre = name;
    this->Descripcion = desc;
    this->Dificultad = difi;
    this->Habilitado = habilitado;
...
bool InformacionCurso::getHabilitado(){ return this->Habilitado; }
